...
## Table of contents
  ...
  - [Creating Mock Classes](#creating-mock-classes)
    + [Dealing with unprotected commas](#dealing-with-unprotected-commas)
    ...
    + [Simplifying the Interface without Breaking Existing Code {#SimplerInterfaces}](#simplifying-the-interface-without-breaking-existing-code-simplerinterfaces)
    + [Alternative to Mocking Concrete Classes](#alternative-to-mocking-concrete-classes)
    + [Delegating Calls to a Fake {#DelegatingToFake}](#delegating-calls-to-a-fake-delegatingtofake)
  ...
  - [Using Matchers](#using-matchers)
    ...
    + [Casting Matchers {#SafeMatcherCast}](#casting-matchers-safematchercast)
    + [Selecting Between Overloaded Functions {#SelectOverload}](#selecting-between-overloaded-functions-selectoverload)
    ...
    + [Matchers must have no side-effects {#PureMatchers}](#matchers-must-have-no-side-effects-purematchers)
  - [Setting Expectations](#setting-expectations)
    ...
    + [Understanding Uninteresting vs Unexpected Calls {#uninteresting-vs-unexpected}](#understanding-uninteresting-vs-unexpected-calls-uninteresting-vs-unexpected)
    + [Ignoring Uninteresting Arguments {#ParameterlessExpectations}](#ignoring-uninteresting-arguments-parameterlessexpectations)
    + [Expecting Ordered Calls {#OrderedCalls}](#expecting-ordered-calls-orderedcalls)
    + [Expecting Partially Ordered Calls {#PartialOrder}](#expecting-partially-ordered-calls-partialorder)
  ...
  - [Using Actions](#using-actions)
    ...
    + [Mocking Side Effects {#MockingSideEffects}](#mocking-side-effects-mockingsideeffects)
    + [Changing a Mock Object's Behavior Based on the State](#changing-a-mock-objects-behavior-based-on-the-state)
    + [Setting the Default Value for a Return Type {#DefaultValue}](#setting-the-default-value-for-a-return-type-defaultvalue)
    + [Setting the Default Actions for a Mock Method](#setting-the-default-actions-for-a-mock-method)
    + [Using Functions/Methods/Functors/Lambdas as Actions {#FunctionsAsActions}](#using-functionsmethodsfunctorslambdas-as-actions-functionsasactions)
    + [Using Functions with Extra Info as Actions](#using-functions-with-extra-info-as-actions)
    + [Invoking a Function/Method/Functor/Lambda/Callback Without Arguments](#invoking-a-functionmethodfunctorlambdacallback-without-arguments)
    ...
    + [Selecting an Action's Arguments {#SelectingArgs}](#selecting-an-actions-arguments-selectingargs)
  ...
  - [Misc Recipes on Using gMock](#misc-recipes-on-using-gmock)
    + [Mocking Methods That Use Move-Only Types](#mocking-methods-that-use-move-only-types)
      - [Legacy workarounds for move-only types {#LegacyMoveOnly}](#legacy-workarounds-for-move-only-types-legacymoveonly)
    + [Making the Compilation Faster](#making-the-compilation-faster)
    + [Forcing a Verification](#forcing-a-verification)
    + [Using Check Points {#UsingCheckPoints}](#using-check-points-usingcheckpoints)
    + [Mocking Destructors](#mocking-destructors)
    + [Using gMock and Threads {#UsingThreads}](#using-gmock-and-threads-usingthreads)
    + [Controlling How Much Information gMock Prints](#controlling-how-much-information-gmock-prints)
  ...
  - [Extending gMock](#extending-gmock)
    + [Writing New Matchers Quickly {#NewMatchers}](#writing-new-matchers-quickly-newmatchers)
    ...
    + [Writing New Actions Quickly {#QuickNewActions}](#writing-new-actions-quickly-quicknewactions)
      - [Legacy macro-based Actions](#legacy-macro-based-actions)
      - [Legacy macro-based parameterized Actions](#legacy-macro-based-parameterized-actions)
    ...
    + [Writing New Monomorphic Actions {#NewMonoActions}](#writing-new-monomorphic-actions-newmonoactions)
    + [Writing New Polymorphic Actions {#NewPolyActions}](#writing-new-polymorphic-actions-newpolyactions)
    + [Teaching gMock How to Print Your Values](#teaching-gmock-how-to-print-your-values)
  - [Useful Mocks Created Using gMock](#useful-mocks-created-using-gmock)
    + [Mock std::function {#MockFunction}](#mock-stdfunction-mockfunction)
